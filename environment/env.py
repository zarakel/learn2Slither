...
from environment.board import Board, Cell
...
class Learn2SlitherEnv(gym.Env):
    ...
    def step(self, action: int):
        """Exécute action -> (Obs, Réc, Term, Tronq, Info)."""
    ...
    def _extract_state(self) -> np.ndarray:
        """
        Génère la vision en croix (agnostique à la taille du plateau).
        Pour chaque direction : [1/d_mur, 1/d_corps, 1/d_vert, 1/d_rouge]
