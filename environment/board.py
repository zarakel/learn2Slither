...
class Board:
    ...
    def reset(self):
        ...
        # Pour faire simple et éviter de générer un serpent "enfermé" dès le départ, 
    ...
    def move(self, action: int) -> Tuple[bool, bool, bool]:
        ...
        Retourne : (is_dead, ate_green, ate_red) pour faciliter le calcul des récompenses.
        """
        ...
        # sauf si on mange une pomme qui nous fait grandir, mais on gère ça au mouvement.
        ...
        if new_head in self.green_apples:
            ...
            if len(self.snake) > 0:
                self.snake.pop() # On pop UNE DEUXIEME FOIS pour diminuer la taille
        else:
